...
$t = @{}
$t["hi-IN"] = @{
  "App.Title" = "आईडी कार्ड सॉफ़्टवेयर"; "Menu.File" = "फ़ाइल"; "Menu.Edit" = "संपादन"; "Menu.View" = "दृश्य"; "Menu.Help" = "सहायता";
  ...
  "Home.Welcome" = "आईडी कार्ड सॉफ़्टवेयर में आपका स्वागत है"; "Status.Ready" = "तैयार" }
$t["mr-IN"] = @{
  "App.Title" = "आयडी कार्ड सॉफ्टवेअर"; "Menu.File" = "फाइल"; "Menu.Edit" = "संपादन"; "Menu.View" = "दृश्य"; "Menu.Help" = "मदत";
  ...
  "Home.Welcome" = "आयडी कार्ड सॉफ्टवेअरमध्ये स्वागत आहे"; "Status.Ready" = "तयार" }
$t["or-IN"] = @{
  "App.Title" = "ପରିଚୟ କାର୍ଡ ସଫ୍ଟୱେର"; "Menu.File" = "ଫାଇଲ"; "Menu.Edit" = "ସମ୍ପାଦନା"; "Menu.View" = "ଦୃଶ୍ୟ"; "Menu.Help" = "ସହାୟତା";
  ...
  "Home.Welcome" = "ପରିଚୟ କାର୍ଡ ସଫ୍ଟୱେରକୁ ସ୍ୱାଗତ"; "Status.Ready" = "ପ୍ରସ୍ତୁତ" }
$t["bn-IN"] = @{
  "App.Title" = "আইডি কার্ড সফটওয়্যার"; "Menu.File" = "ফাইল"; "Menu.Edit" = "সম্পাদনা"; "Menu.View" = "ভিউ"; "Menu.Help" = "সাহায্য";
  ...
  "Home.Welcome" = "আইডি কার্ড সফটওয়্যারে স্বাগতম"; "Status.Ready" = "প্রস্তুত" }
$t["ta-IN"] = @{
  "App.Title" = "அடையாள அட்டை மென்பொருள்"; "Menu.File" = "கோப்பு"; "Menu.Edit" = "திருத்து"; "Menu.View" = "பார்வை"; "Menu.Help" = "உதவி";
  ...
  "Home.Welcome" = "அடையாள அட்டை மென்பொருளுக்கு வரவேற்கிறோம்"; "Status.Ready" = "தயார்" }
$t["te-IN"] = @{
  "App.Title" = "ఐడీ కార్డ్ సాఫ్ట్‌వేర్"; "Menu.File" = "ఫైల్"; "Menu.Edit" = "సవరణ"; "Menu.View" = "వీక్షణ"; "Menu.Help" = "సహాయం";
  ...
  "Home.Welcome" = "ఐడీ కార్డ్ సాఫ్ట్‌వేర్‌కు స్వాగతం"; "Status.Ready" = "సిద్ధం" }
$t["kn-IN"] = @{
  "App.Title" = "ಐಡಿ ಕಾರ್ಡ್ ಸಾಫ್ಟ್‌ವೇರ್"; "Menu.File" = "ಫೈಲ್"; "Menu.Edit" = "ಸಂಪಾದನೆ"; "Menu.View" = "ವೀಕ್ಷಣೆ"; "Menu.Help" = "ಸಹಾಯ";
  ...
  "Home.Welcome" = "ಐಡಿ ಕಾರ್ಡ್ ಸಾಫ್ಟ್‌ವೇರ್‌ಗೆ ಸ್ವಾಗತ"; "Status.Ready" = "ಸಿದ್ಧ" }
$t["gu-IN"] = @{
  "App.Title" = "આઈડી કાર્ડ સોફ્ટવેર"; "Menu.File" = "ફાઇલ"; "Menu.Edit" = "સંપાદન"; "Menu.View" = "દૃશ્ય"; "Menu.Help" = "સહાય";
  ...
  "Home.Welcome" = "આઈડી કાર્ડ સોફ્ટવેરમાં આપનું સ્વાગત છે"; "Status.Ready" = "તૈયાર" }
$t["pa-IN"] = @{
  "App.Title" = "ਆਈਡੀ ਕਾਰਡ ਸੌਫਟਵੇਅਰ"; "Menu.File" = "ਫਾਈਲ"; "Menu.Edit" = "ਸੋਧ"; "Menu.View" = "ਵੇਖੋ"; "Menu.Help" = "ਮਦਦ";
  ...
  "Home.Welcome" = "ਆਈਡੀ ਕਾਰਡ ਸੌਫਟਵੇਅਰ ਵਿੱਚ ਜੀ ਆਇਆਂ ਨੂੰ"; "Status.Ready" = "ਤਿਆਰ" }
$t["es-ES"] = @{
  "App.Title" = "Software de Tarjetas de Identificación"; "Menu.File" = "Archivo"; "Menu.Edit" = "Editar"; "Menu.View" = "Ver"; "Menu.Help" = "Ayuda";
  ...
  "Home.Welcome" = "Bienvenido al Software de Tarjetas de Identificación"; "Status.Ready" = "Listo" }
